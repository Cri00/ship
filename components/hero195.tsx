...
const Hero195 = ({
  title = "Pornește și administrează afacerea ta fără drumuri, dosare sau stres",
  description = "Te-ai întrebat: „Cum deschid o firmă?”, „Unde găsesc un contabil?”, „Pot să fac modificări fără să pierd timp la Registru?”, „Cum închid o firmă fără să mă blochez în acte?”. Dacă ai trecut prin asta, Regnet este exact ce-ți trebuie.",
    ...
    <section className="overflow-hidden">
      <div className="container">
        <div className="border-border border-x py-20">
          <div className="relative mx-auto max-w-6xl p-2">
            <h1 className="mx-1 mt-6 text-center text-5xl font-bold tracking-tighter md:text-7xl">
              {title}
            </h1>
            <p className="text-muted-foreground mx-auto mt-6 max-w-xl text-center text-lg font-medium md:text-xl">
              {description}
            </p>
