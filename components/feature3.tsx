          ...
          <div className="mt-10 grid grid-cols-1 place-items-center gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Înființare SRL</h2>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Înființare PFA</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Contabilitate PFA</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Contabilitate SRL</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Găzduire</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">OSIM</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
